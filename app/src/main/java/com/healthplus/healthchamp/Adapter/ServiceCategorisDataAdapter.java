...
import com.healthplus.healthchamp.Fragment.EventFragment;
import com.healthplus.healthchamp.Fragment.ExpertServiceFragment;
import com.healthplus.healthchamp.Fragment.ServiceFragment;
...
public class ServiceCategorisDataAdapter extends RecyclerView.Adapter<ServiceCategorisDataAdapter.ViewHolder> {
    ...
    public ServiceCategorisDataAdapter(ArrayList<HealthChampPlusData> list_data, Context context) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.layout_service.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (list_data.get(position).getName().equals("Events"))
                {
                ...
                else if (list_data.get(position).getName().equals("Talk To Expert"))
                {
                    ...
                    prefsEditr1.putString("expertservicecategoryid", list_data.get(position).getId());
                    prefsEditr1.commit();
                }
                else {
                    ServiceFragment f1 = new ServiceFragment();
                    FragmentTransaction ft = ((FragmentActivity) context).getSupportFragmentManager().beginTransaction();
                    ft.replace(R.id.nav_host_fragment, f1);
                    ft.addToBackStack(null);
                    ft.commit();
                    SharedPreferences mypref1 = PreferenceManager.getDefaultSharedPreferences(context);
                    SharedPreferences.Editor prefsEditr1 = mypref1.edit();
                    prefsEditr1.putString("servicecategoryid", list_data.get(position).getId());
                    prefsEditr1.commit();
                }
            }
        });
