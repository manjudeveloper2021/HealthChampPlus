...
public class ExpertServiceSubCategorisDataAdapter extends RecyclerView.Adapter<ExpertServiceSubCategorisDataAdapter.ViewHolder> {
    ...
    public ExpertServiceSubCategorisDataAdapter(ArrayList<HealthChampPlusData> list_data, Context context) {
...
//                .into(holder.imgicon);
        holder.layout_service.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                prefsEditr1.putString("counsellingtypeiduser", list_data.get(position).getId());
                prefsEditr1.putString("counsellingtypenameuser", list_data.get(position).getName());
                prefsEditr1.commit();
            }
        });
