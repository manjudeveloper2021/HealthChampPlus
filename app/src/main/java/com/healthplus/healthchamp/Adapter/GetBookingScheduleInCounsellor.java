...
import com.healthplus.healthchamp.Activity.UploadPrescriptionByCounselor;
import com.healthplus.healthchamp.Activity.UploadReportByCounselor;
import com.healthplus.healthchamp.Model.HealthChampPlusData;
import com.healthplus.healthchamp.R;

import java.util.ArrayList;

public class GetBookingScheduleInCounsellor extends RecyclerView.Adapter<GetBookingScheduleInCounsellor.ViewHolder> {
    ...
    public GetBookingScheduleInCounsellor(ArrayList<HealthChampPlusData> list_data, Context context) {
        this.list_data = list_data;
        this.context = context;
    }
    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.design_bookingcounselling,parent,false);
...
//
//        }
        holder.txtuploadPrescription.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, UploadPrescriptionByCounselor.class);
                context.startActivity(intent);
            }
        });
        holder.txtuploadReport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, UploadReportByCounselor.class);
                context.startActivity(intent);
            }
        });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        private TextView txtslot,txtdate,txtname,txtmail,txtmobile,txttype,txtmode,takecounselling,txtuploadPrescription,txtuploadReport;
        private TextView txtid;
        public ViewHolder(View itemView) {
            super(itemView);
            txtuploadReport = (TextView) itemView.findViewById(R.id.txtuploadReport);
            txtuploadPrescription = (TextView) itemView.findViewById(R.id.txtuploadPrescription);
